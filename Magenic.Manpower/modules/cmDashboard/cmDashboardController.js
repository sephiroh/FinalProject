(function () {
    ...
    cmDashboardController.$inject = ['$scope', '$timeout', 'cmDashboardContext', 'toaster'];

    function cmDashboardController($scope, $timeout, cmDashboardContext, toaster) {
        this.list = [];
        ...
        var populateList = function () {
            cmDashboardContex.getManpowerRequest().then(
                function (response) {
